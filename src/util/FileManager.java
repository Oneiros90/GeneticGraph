...
public class FileManager {
    ...
    /**
     * Restituisce un'immagine contenuta nelle risorse dell'applicazione
     * @param path Path relativo dell'immagine
     * @return L'immagine sottoforma di oggetto "Image"
     */
    public static BufferedImage getImageFromResource(String path) {
        URL resource = FileManager.class.getResource(path);
        try {
    ...
    public static String readTextFromResource(String path) {
        ...
        //Ottengo il flusso di byte del file di testo da leggere
        InputStream byteStream = FileManager.class.getClassLoader().getResourceAsStream(path);
